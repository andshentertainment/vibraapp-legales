...
El Usuario reconoce que la Aplicación cuenta con la clasificación de edad correspondiente en las tiendas de aplicaciones oficiales (Google Play y App Store), instando a los padres o tutores a configurar los controles parentales en los dispositivos como mecanismo adicional de restricción de acceso a menores de edad.
...
Algunas funcionalidades de la Aplicación pueden utilizarse sin necesidad de registro. Para acceder a funciones adicionales (como sincronización de datos, Contenido Premium o el Modo Previa completo), el Usuario deberá crear una Cuenta mediante correo electrónico y contraseña, o a través de inicio de sesión con Google.

El Usuario se compromete a:

a) Proporcionar información veraz, exacta y actualizada al momento del registro.
b) Mantener la confidencialidad de sus credenciales de acceso.
c) Notificar de inmediato cualquier uso no autorizado de su Cuenta.
d) No crear cuentas en nombre de terceros sin autorización, ni suplantar la identidad de otra persona.

El Titular no será responsable por los daños o perjuicios derivados del uso indebido de las credenciales de acceso por parte de terceros, salvo que dicho uso sea consecuencia de una falla de seguridad directamente imputable al Titular.

## 6. Uso responsable y conducta del Usuario

El Usuario se obliga a utilizar la Aplicación de conformidad con la ley, la moral, el orden público y estos Términos. Queda prohibido:

a) Utilizar la Aplicación con fines fraudulentos, ilícitos o lesivos a los derechos de terceros.
b) Intentar vulnerar, descompilar, alterar o realizar ingeniería inversa sobre la Aplicación o sus sistemas de seguridad.
c) Utilizar mecanismos automatizados (bots, scrapers, etc.) para acceder a la Aplicación o extraer su contenido.
d) Revender, sublicenciar o explotar comercialmente la Aplicación o su contenido sin autorización expresa del Titular.

El Titular podrá suspender o cancelar el acceso de un Usuario que incumpla estos Términos, sin perjuicio de las acciones legales que correspondan.

## 7. Suscripciones y pagos (Premium)

VibraApp ofrece contenido y funcionalidades adicionales mediante una suscripción paga ("Premium"). Las suscripciones son gestionadas a través de **RevenueCat** como plataforma de administración de suscripciones, y procesadas mediante los sistemas de facturación de **Google Play Store** y/o **Apple App Store**, según corresponda al dispositivo del Usuario.

a) **Precios:** los precios de las suscripciones se muestran en la Aplicación antes de confirmar la compra y pueden variar según el país, la moneda local y las políticas de cada tienda de aplicaciones.
b) **Renovación automática:** salvo que se indique lo contrario al momento de la compra, las suscripciones se renuevan automáticamente al finalizar cada período, cargándose el importe correspondiente al método de pago asociado a la cuenta de la tienda de aplicaciones del Usuario, a menos que este cancele la renovación automática con al menos 24 horas de anticipación al vencimiento del período vigente.
c) **Cancelación:** el Usuario puede cancelar su suscripción en cualquier momento desde la configuración de su cuenta de Google Play o Apple App Store. La cancelación surtirá efecto al finalizar el período ya pagado; no se realizan reembolsos proporcionales por el tiempo no utilizado, salvo que la ley aplicable disponga lo contrario.
d) **Reembolsos:** las solicitudes de reembolso se rigen por las políticas de la tienda de aplicaciones correspondiente (Google Play o App Store), ya que el Titular no procesa directamente los pagos ni tiene acceso a los datos completos de la tarjeta o método de pago del Usuario.
e) **Restauración de compras:** el Usuario puede restaurar sus compras previas desde la sección "Premium" de la Aplicación.
...
Asimismo, el Titular podrá modificar estos Términos en cualquier momento. Las modificaciones sustanciales serán comunicadas a través de la Aplicación o al correo electrónico registrado por el Usuario. El uso continuado de la Aplicación tras la publicación de los cambios implica la aceptación de los nuevos Términos.
